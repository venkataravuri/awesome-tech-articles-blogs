...
- Bounded contexts are a pattern in DDD that _represent partitions in the domain model_. Similar to subdomains, which are partitions in the domain, bounded contexts are partitions in the domain model.
